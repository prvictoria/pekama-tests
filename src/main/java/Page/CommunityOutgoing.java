...
//    public static String caseRowByName = "//div[starts-with(@class, 'case-item') and .//ancestor::h3[text()='Patent in Åland Islands']]";
    ...
    public static final String ROW_CONTROL_CASE_NAME = caseRow+"//*[@class='name']//h3";
    public static final String ROW_CONTROL_FIELD_CASE_NAME = caseRow+"//input[@name='title']";
    public static final String ROW_CONTROL_LABEL_CASE = caseRow+"//*[@class='type']/span";
    public static final String ROW_CONTROL_BTN_ACTION = caseRow+"//*[@class='status']/button";
    public static final String ROW_CONTROL_LABEL_STATUS = "//*[@class='status']/div/span";
    public static final String ROW_CONTROL_BTN_ARCHIVE = caseRow+"//button[./i]";
}
