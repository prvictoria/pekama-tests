...
public class PekamaLogin {
    ...
    public static final SelenideElement lOGIN_TITLE_TEXT = $(byText("Login"));

    public static final SelenideElement loginLinkedin = $(byXpath(""));
    public static final SelenideElement loginGoogle = $(byXpath(""));
    public static final SelenideElement loginField_Email = $(byXpath("#loginEmail"));
    public static final SelenideElement loginField_Password = $(byXpath("#loginPassword"));
    ...
    public static final SelenideElement loginErrorMsg = $(byText("Please enter a correct email address and password. Note that both fields may be case-sensitive."));
