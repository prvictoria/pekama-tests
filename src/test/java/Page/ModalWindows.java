...
//    public static final SelenideElement MW_DOC_TEMPLATE_ = $(byXpath(mw+""));
    ...
    public static final SelenideElement MW_TASK_SELECT_STATUS = $(byXpath(mw+"//label[contains(.,'Status')]/following-sibling::div//span"));
    public static final SelenideElement MW_TASK_INPUT_STATUS = $(byXpath(mw+"//label[contains(.,'Status')]/following-sibling::div//input[@type='search']"));
    ...
    public static final SelenideElement MW_CHARGES_SELECT_TO = $(byXpath(mw+"//label[contains(.,'To:')]/following-sibling::div//span"));
    ...
    public static final SelenideElement MW_CONFIRM_INVITE_ATTORNEY_TEXT = $(byText("Notice that the default message doesn't have a name on the first line."));
    public static final SelenideElement MW_CONFIRM_INVITE_ATTORNEY_DISMISS = $(byXpath(mw+"//button[contains(text(),'No, let me change the message')]"));
