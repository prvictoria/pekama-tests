...
public class Emails extends Page {
    ...
    public static String EMAIL_INVITE_IN_PROJECT_TEXT = "%s %s from created a project for %s and invites you to join in."; //ObjectUser name, Surname, ProjectValues name
