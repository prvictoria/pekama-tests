package draft;
/**
 * Created by Viachaslau_Balashevi on 4/7/2017.
 */
...
public class DeleteEmail {
    ...
    public static void fromMatch(Message message) throws MessagingException {
        Address from = message.getFrom()[0];
        if (from.equals("noreply@emstaging.pekama.com"));
        message.setFlag(Flags.Flag.DELETED, true);
    }
